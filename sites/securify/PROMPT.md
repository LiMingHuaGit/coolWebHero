...
新页面：Build a full-screen hero section for a data-security SaaS landing page called "securify" using React + TypeScript + Tailwind CSS, with a looping fullscreen background video, a floating pill-shaped navbar, and large staggered typography.
...
`absolute right-6 md:right-24 top-[14%]`:
...
`absolute left-6 md:left-20 bottom-20 md:bottom-24`:
...
`absolute right-6 md:right-20 bottom-16 md:bottom-20`:
